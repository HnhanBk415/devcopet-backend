# Applied Practice: Training Counter

## Purpose and Use Case

This lesson is part of **Loops**.

Create a training counter that tracks progress over several rounds.
...
The core idea of this lesson is **training counter**.
...
```text
Loops are useful for repeated progress updates.
```
...
for round_number in range(1, 4):
    total_xp += 10
    print("Round", round_number, "XP:", total_xp)
```
...
In this lesson, you learned the beginner foundation of **training counter**.
