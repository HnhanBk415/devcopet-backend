...
The core idea of this lesson is **while loops**.
...
```text
A while loop needs an update so it can eventually stop.
```
...
In this lesson, you learned the beginner foundation of **while loops**.
