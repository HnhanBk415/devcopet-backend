...
A for loop with range() is ideal when you know the number of repeats.
...
The core idea of this lesson is **for range**.
...
```text
range() helps repeat code a fixed number of times.
```
...
In this lesson, you learned the beginner foundation of **for range**.
