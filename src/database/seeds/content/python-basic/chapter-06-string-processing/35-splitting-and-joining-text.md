...
split() breaks text into pieces; join() puts pieces back together.
...
The core idea of this lesson is **split join**.
...
```text
split creates a list; join combines strings.
```
...
In this lesson, you learned the beginner foundation of **split join**.
