...
Programs often need to validate text before trusting it.
...
The core idea of this lesson is **string search**.
...
```text
Use membership and methods to check text.
```
...
In this lesson, you learned the beginner foundation of **string search**.
