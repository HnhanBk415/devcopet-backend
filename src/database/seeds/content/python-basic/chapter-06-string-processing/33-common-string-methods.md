...
String methods are ready-made tools for cleaning and transforming text.
...
The core idea of this lesson is **string methods**.
...
```text
String methods return transformed text.
```
...
In this lesson, you learned the beginner foundation of **string methods**.
