...
A dictionary stores data by meaningful keys instead of numeric positions.
...
The core idea of this lesson is **dictionaries**.
...
In this lesson, you learned the beginner foundation of **dictionaries**.
