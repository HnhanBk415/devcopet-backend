...
The core idea of this lesson is **logic**.
...
```text
Comparison operators create booleans; logical operators combine booleans.
```
...
level = 5
has_badge = True
can_enter = level >= 5 and has_badge
print(can_enter)
```
...
In this lesson, you learned the beginner foundation of **logic**.
