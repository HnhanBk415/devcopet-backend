...
The core idea of this lesson is **basic types**.
...
```text
Strings store text, booleans store True/False, and None means no value yet.
```
...
is_active = True
next_badge = None
print(name, is_active, next_badge)
```
...
In this lesson, you learned the beginner foundation of **basic types**.
