...
The core idea of this lesson is **functions**.
...
```text
Define a function once and call it when needed.
```
...
In this lesson, you learned the beginner foundation of **functions**.
