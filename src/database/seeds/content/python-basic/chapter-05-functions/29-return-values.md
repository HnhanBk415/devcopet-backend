...
print shows a value; return sends a value back to the caller.
...
The core idea of this lesson is **return**.
...
In this lesson, you learned the beginner foundation of **return**.
