# else for Alternative Paths

## Purpose and Use Case

This lesson is part of **Conditions**.

else gives your program a backup path.
...
The core idea of this lesson is **else**.
...
```text
Use else when you need a default alternative.
```
...
In this lesson, you learned the beginner foundation of **else**.
