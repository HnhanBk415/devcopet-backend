...
Sometimes your function should reject bad data immediately.
...
The core idea of this lesson is **raise**.
...
```text
raise lets your function reject invalid input clearly.
```
...
In this lesson, you learned the beginner foundation of **raise**.
