...
Exceptions are Python’s way of saying “I cannot continue safely.”
...
The core idea of this lesson is **exceptions**.
...
```text
Exceptions happen when Python cannot safely complete an operation.
```
...
```python
text = "abc"
# int(text) would raise ValueError
print("Bad numeric text can cause an exception")
```
...
In this lesson, you learned the beginner foundation of **exceptions**.
