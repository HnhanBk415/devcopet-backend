...
try/except lets your program handle expected failure without crashing.
...
The core idea of this lesson is **try except**.
...
```text
Use except for expected errors you know how to handle.
```
...
In this lesson, you learned the beginner foundation of **try except**.
