# Reading Whole Files and Lines

## Purpose and Use Case

This lesson is part of **Basic File Reading and Writing**.

Reading files is how programs load saved information.
...
The core idea of this lesson is **read files**.
...
```text
read() loads the whole file; readlines() loads lines into a list.
```
...
In this lesson, you learned the beginner foundation of **read files**.
