# Applied Practice: Save Progress

## Purpose and Use Case

This lesson is part of **Basic File Reading and Writing**.

Build a small save system for learning progress.
...
The core idea of this lesson is **save progress**.
...
```text
File writing lets a program save simple progress.
```
...
In this lesson, you learned the beginner foundation of **save progress**.
