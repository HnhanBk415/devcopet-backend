...
CSV-style text stores table-like data using separators.
...
The core idea of this lesson is **csv style**.
...
```text
CSV-style data can be split by separators.
```
...
In this lesson, you learned the beginner foundation of **csv style**.
