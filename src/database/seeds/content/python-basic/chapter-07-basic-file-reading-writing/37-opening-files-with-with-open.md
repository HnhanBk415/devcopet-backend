...
Files let a program read from and write to the outside world.
...
The core idea of this lesson is **with open**.
...
In this lesson, you learned the beginner foundation of **with open**.
